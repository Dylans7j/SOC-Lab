...
|---|---|---|
| [Splunk SPL](./spl/DE-004-sysmon-outbound-smb.spl) | DE-004: initiated TCP 445 endpoint hunt | **Exact-window hunt observed once; generalized version not retested** |
| [Network analytic](./network/DE-004-llmnr-to-smb.md) | DE-004: suspicious response followed by SMB | **Detection design only; no automatic alert test** |
...
[DE-001 report](../case-studies/DE-001-Repeated-Failed-AD-Logons/) · [DE-002 report](../case-studies/DE-002-AD-Password-Spray-Detection/) · [DE-003 report](../case-studies/DE-003-BadUSB-PowerShell-Investigation/) · [DE-004 report](../case-studies/DE-004-LLMNR-NBTNS-Poisoning/).
